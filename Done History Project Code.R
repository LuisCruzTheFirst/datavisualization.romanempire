...
# The file is on a shape file, which is a geospatial file, so I need to install and 
# download a specific R package that will allow me to read and manipulate it. 
...
# Let's have a glimpse of how the data set is structured and let's see if we can get some
# useful information for our data visualization.
summary(cities)
